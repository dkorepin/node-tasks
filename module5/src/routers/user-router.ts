...
usersRouter
  .route("/")
  .get(serviceLogger.method("get all"), async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  .post(serviceLogger.method("create new"), validateUser, async (req: Request, res: Response, next: NextFunction) => {
    try {
...
usersRouter
  .route("/addToGroup/:id")
  .all(serviceLogger.method("add to group"), async (req: Request, res: Response, next) => {
    try {
